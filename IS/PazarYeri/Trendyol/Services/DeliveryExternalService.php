...
Class DeliveryExternalService extends Request
{
	 ...
	 *
	 */
	public function createCommonLabel($cargoTrackingNumber)
	{
		$this->setApiUrl('https://sellerpublic-sdc.trendyol.com/delivery-delivery-external-service/sellers/{supplierId}/common-label/{cargoTrackingNumber}');
		return $this->getResponse(true, ['cargoTrackingNumber' => $cargoTrackingNumber]);
	}
